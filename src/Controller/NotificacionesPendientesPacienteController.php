...
{
    #[Route('/notificaciones/pendientes/paciente', name: 'app_notificaciones_pendientes_paciente')]
                ...
                foreach($notificaciones as $notificacion){
                    ...
                    if ( $notificacion->getLeida() == 0){
                        ...
                        if (  $diasAntelacino > 0){
                            ...
                            $notifArray['fecha_notificacion'] =date_format($turno->getFechaBaja(), "d-m-Y");;
                            // dd($notifArray);
                        }
                        ...
                        $notifArray['id_notificacion']  = $notificacion->getId();
